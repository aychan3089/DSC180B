...
def get_data(scientific_path, misinformation_path, scientific_list, misinformation_list, test_misinformation_path, test_scientific_path, test_output_path):
...
def get_csvs(scientific_path, misinformation_path, scientific_list, misinformation_list, test_output_path, test_misinformation_path, test_scientific_path):
