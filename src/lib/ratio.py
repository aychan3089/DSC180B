...
def get_ratio_csv(scientific_path, misinformation_path, scientific_list, misinformation_list, test_misinformation_path, test_output_path, test_scientific_path):
